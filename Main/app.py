...
class Ventana(QWidget):
    def __init__(self):
        ...
        # Crear QStackedWidget para gestionar las distintas "pantallas"
        ...
        self.stack.addWidget(self.perfil_widget)
        self.stack.addWidget(self.password_widget)

        # Botón menú desplegable en la ventana principal (ícono hamburguesa)
...
class PasswordGenerator(QWidget):
    def __init__(self):
        ...
        # Aquí se mueven todos los widgets y lógica del generador de contraseñas
        # Título
        ...
        self.btn_generar.setStyleSheet('''
            QPushButton {
                font-family: Helvetica; font-size: 20px; color: white; background-color: #366CF0;
